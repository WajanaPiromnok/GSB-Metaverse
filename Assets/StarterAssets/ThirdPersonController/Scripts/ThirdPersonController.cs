...
namespace StarterAssets
{
	...
	public class ThirdPersonController : MonoBehaviour
	{
		...
		public bool PlayerIsSit;
		float m_DelaySit;

		[SerializeField] bool mouseClick;
		[SerializeField] bool isMoneyExpo;
		...
		private void Update()
		{
			if (isMoneyExpo)
			{
				if (Input.GetMouseButton(1) || Input.GetMouseButton(0) || Input.GetKey(KeyCode.W) || Input.GetKey(KeyCode.S) || Input.GetKey(KeyCode.A) || Input.GetKey(KeyCode.D) || Input.GetKey(KeyCode.LeftShift) || Input.GetKey(KeyCode.Space) || Input.GetKey(KeyCode.UpArrow) || Input.GetKey(KeyCode.DownArrow) || Input.GetKey(KeyCode.RightArrow) || Input.GetKey(KeyCode.LeftArrow))
				{
					mouseClick = true;
				}
			}
		...
		private void Move()
		{
			...
			if (m_DelaySit < 0.5f)
				m_DelaySit += Time.deltaTime;

			if (_input.move != Vector2.zero || _input.jump || transform.parent == null)
			{
